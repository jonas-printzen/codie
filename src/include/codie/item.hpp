...
/** @brief An explicit RTTI-object with an uid
 *
 ...
 */
template <Item::hash_t H, typename T=void>
...
public:
  ...
  class If {
  public:
    constexpr If( Item &item ) : _item(item) {}
  ...
  static const hash_t ID=H;

  static inline constexpr bool Is( Item &item ) { return ID==item.uid; }
